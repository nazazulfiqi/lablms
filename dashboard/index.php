...
<div class="container">
  <div class="row gy-4">
    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
      <h1 data-aos="fade-up"><?php echo htmlspecialchars($courseCount); ?> courses and <?php echo htmlspecialchars($videoCount); ?> videos available for you to explore!</h1>
            ...
            <div class="row gy-4">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<img src="data:image/jpeg;base64,' . base64_encode($row['thumbnail']) . '" class="fixed-size-img img-fluid" alt="">';
