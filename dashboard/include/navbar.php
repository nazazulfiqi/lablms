        ...
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    ...
                    <li><a href="courses.php" class="<?= $current_page == 'courses' ? 'active' : '' ?>">Courses</a></li>
                    <li><a href="favorite.php" class="<?= $current_page == 'favorite' ? 'active' : '' ?>">Favorite</a>
                    </li>
                    <li><a href="profile.php" class="<?= $current_page == 'profile' ? 'active' : '' ?>">My Profile</a>
                    </li>
                    <?php if ($loggedIn): ?>
