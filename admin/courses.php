...
$sql_courses = "SELECT nama_praktikum, deskripsi_praktikum FROM praktikum LIMIT $start_index, $results_per_page";
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-end mb-3">
                            <a href="create_course.php" class="btn btn-primary">Add Course</a>
                        </div>
    ...
    <script>
        ...
        function deleteCourse(courseName) {
            $.ajax({
                ...
                data: { nama_praktikum: courseName }, // Pass courseName as data parameter
                dataType: 'json',
