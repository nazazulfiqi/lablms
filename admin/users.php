...
// Fetch data for users table with pagination
$sql_users = "SELECT id, fname, lname, email, role FROM users LIMIT $start_index, $results_per_page";
...
<body>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $result_users->fetch_assoc()) {
                                        ...
                                        echo "<td>
                                                <a href='edit_user.php?id=" . urlencode($row['id']) . "' class='btn btn-sm btn-info'>Edit</a>
                                                <a href='javascript:void(0);' onclick='confirmDeleteUser(" . urlencode($row['id']) . ");' class='btn btn-sm btn-danger'>Delete</a>
                                            </td>";
                                        echo "</tr>";
                                    }
                                    ?>
    ...
    <script>
        // Function to confirm deletion and then call deleteUser function
        function confirmDeleteUser(userId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Call deleteUser function if user confirms
                    deleteUser(userId);
                }
            });
        }
        ...
        function deleteUser(userId) {
            $.ajax({
                type: 'POST',
                url: 'delete_user.php',
                data: { id: userId }, // Pass userId as data parameter
                dataType: 'json',
