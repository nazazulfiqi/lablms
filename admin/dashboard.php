...
if (isset($_SESSION['id'])) {
    ...
    if ($role == 'ADMIN') {
        ...
        $sql = "SELECT id_video, judul_video, deskripsi_video, url_video, url_thumbnail, nama_praktikum FROM videos";
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <div class="d-flex gap-2 justify-content-center mb-2 align-items-center mt-4">
                        ...
                        <a href="index.html"><img src="../assets/img/jakarta-logo.png" alt="" width="50"
                                height="50"></a>
                        <h4 class="fw-bolder" style="color: #d9232d;">TENUN</h4>
                    </div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="./berita.php" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="../config/logoutFunction.php" aria-expanded="false">
                                <span>
